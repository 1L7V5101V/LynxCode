...
SKILL_FILE_CREATION_GUIDE = """When creating Nova skill files at .nova/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${NOVA_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".nova" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".nova" / "skills", "project"),
    ]
