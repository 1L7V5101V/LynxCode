...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available Nova skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a Nova skill."),
    ...
    SlashCommand("exit", "/exit", "Exit Nova.", ("quit",)),
)
