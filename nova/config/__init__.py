...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "nova" / "config.toml"
PROJECT_CONFIG_NAME = ".nova.toml"
...
ENV_PROVIDER = "NOVA_PROVIDER"
ENV_API_KEY = "NOVA_API_KEY"
ENV_BASE_URL = "NOVA_BASE_URL"
ENV_MODEL = "NOVA_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("NOVA_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("NOVA_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("NOVA_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
            "NOVA_ANTHROPIC_API_KEY",
            "ANTHROPIC_API_KEY",
            "NOVA_RIGHT_CODES_API_KEY",
            "RIGHT_CODES_API_KEY",
            "NOVA_OPENAI_API_KEY",
            "OPENAI_API_KEY",
        ),
        "base_url": (
            "NOVA_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("NOVA_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("NOVA_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "NOVA_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("NOVA_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("NOVA_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("NOVA_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid Nova config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read Nova config file {path}: {exc}") from exc
